 ...
 * @hidden
 */
var getIterator = function (data, _a) {
...
var ArrayIterator = /** @class */ (function () {
    ...
    ArrayIterator.prototype[iterator$1] = function () {
        return this;
    };
...
var Iterator = /** @class */ (function () {
    ...
    Iterator.prototype[iterator$1] = function () {
        return this;
    };
...
var GroupIterator = /** @class */ (function () {
    ...
    GroupIterator.prototype[iterator$1] = function () {
        return this;
    };
...
var DataResultIterator = /** @class */ (function () {
    ...
    DataResultIterator.prototype[iterator$1] = function () {
...
var DataCollection = /** @class */ (function () {
    ...
    DataCollection.prototype[iterator$1] = function () {
...
var ScrollSyncService = /** @class */ (function () {
    function ScrollSyncService(ngZone) {
        ...
        this.changeSubscription.add(this.changes.pipe(distinctUntilChanged$1(function (x, y) { return x.scrollLeft === y.scrollLeft; }))
...
var ScrollerService = /** @class */ (function () {
    ...
    ScrollerService.prototype.create = function (rowHeightService, skip, take$$1, total) {
        ...
        var subject = new BehaviorSubject$1(new ScrollAction(this.rowHeightService.offset(skip)));
    ...
    ScrollerService.prototype.onScroll = function (_a, observer) {
        ...
        if (!up) {
            if (lastItemIndex >= this.lastLoaded && this.lastLoaded < this.total) {
                ...
                var atBottom = Math.round(scrollTop) === scrollHeight - clientHeight;
                if (atBottom) {
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.handleRowSync = function () {
        ...
        return merge$1(this.changeNotification.changes, this.groupsService.changes
            .pipe(filter$1(isLocked), switchMapTo$1(this.ngZone.onStable.asObservable().pipe(take$1(1)))), this.editService.changed, this.resizeService.changes).pipe(tap$1(function () { return _this.resetNavigationViewport(); }), filter$1(isLocked))
            .subscribe(function () {
