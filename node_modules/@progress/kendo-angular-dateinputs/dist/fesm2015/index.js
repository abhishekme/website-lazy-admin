...
class ScrollerService {
    ...
    create(rowHeightService, skip, take, total, topOffset = 0, bottomOffset = 0, direction = 'vertical') {
        ...
        const subject = new ReplaySubject$1(2);
    ...
    animateToIndex(index) {
        ...
        this.zone.runOutsideAngular(() => {
            this.animationSubscription =
                combineLatest$1(of$1(start), interval$1(0, animationFrame$1)).pipe(map$1(stream => stream[0]), scan$1(modifyScroll), takeWhile$1(isScrollValid), map$1(normalizeScroll)).subscribe((x) => this.scrollTo(x));
        });
    }
...
/** @nocollapse */
DateRangeService.ctorParameters = () => [];
...
class DateRangePopupComponent {
    constructor(popupService, dateRangeService, zone, rtl) {
         ...
         */
        this.popupUID = guid();
        this.calendarSubscriptions = new Subscription$1(() => { });
        this.subscriptions = new Subscription$1(() => { });
        this.resolvedPromise = Promise.resolve();
    }
    /**
    ...
    activate() {
        ...
        this.show = true;
        this.zone.runOutsideAngular(() => {
            this.activateSubscription = merge$1(this.contentCalendar.changes, this.viewCalendar.changes)
                .pipe(filter$1(changes => changes && changes.first), map$1(changes => changes.first))
    ...
    subscribeFocusBlur(calendar) {
        ...
        this.blurSubscription = fromEvent$1(nativeElement, 'blur').subscribe(() => this.onBlur.emit());
        this.focusSubscription = fromEvent$1(nativeElement, 'focus').subscribe(() => this.onFocus.emit());
    }
    ...
    _toggle(show) {
        ...
        if (this._show) {
            ...
            this.addSubscriptions(fromEvent$1(popupElement, 'keydown').subscribe(this.handleKeydown.bind(this)), fromEvent$1(popupElement, 'mouseleave').subscribe(this.handleMouseLeave.bind(this)), popupAnchorViewportLeave.subscribe(() => this.cancelPopup()), popupClose.subscribe(() => this.close.emit()), popupOpen.subscribe(() => this.open.emit()));
        }
    }
}
...
class DateRangeInput {
    constructor(activeRangeEnd, dateRangeService, input, element, renderer, zone) {
        ...
        this.popupSubscriptions = new Subscription$1(() => { });
        this.subscriptions = new Subscription$1(() => { });
    }
    get isActiveEnd() {
    ...
    init() {
        ...
        [
            ...
            fromEvent$1(this.element.nativeElement, 'click').subscribe(() => this.activate()),
            fromEvent$1(this.element.nativeElement, 'keydown').subscribe((event) => this.togglePopup(event || {}))
...
class DateRangeSelectionDirective {
    ...
    ngOnInit() {
        ...
        this.addSubscriptions(calendar.cellEnter.subscribe((value) => this.handleHover(value)), calendar.valueChange.subscribe((value) => this.handleChange(value)), dateRangeService.focusedDate$.subscribe(focusedDate => {
            ...
            this.updateFocusedDate(range$$1);
        }), fromEvent$1(this.element.nativeElement, 'blur').subscribe(() => this.handleBlur()));
    }
    ngOnDestroy() {
        this.calendarSubscriptions.unsubscribe();
    }
...
/** @nocollapse */
VirtualizationModule.ctorParameters = () => [];
...
/** @nocollapse */
MultiViewCalendarModule.ctorParameters = () => [];
...
/** @nocollapse */
CalendarsModule.ctorParameters = () => [];
...
/** @nocollapse */
DateInputModule.ctorParameters = () => [];
...
class TimeListComponent {
    ...
    bindEvents() {
        this.scrollSubscription = this.virtualization
            .scroll$()
            .pipe(debounceTime$1(100), map$1((e) => e.target.scrollTop), map$1((top) => this.itemOffset(top)), map$1((itemOffset) => this.virtualization.itemIndex(itemOffset)))
            .subscribe(index => {
