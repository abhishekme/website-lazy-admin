...
import { scan as scan$1 } from 'rxjs/operators/scan';
...
var ScrollerService = /** @class */ (function () {
    ...
    ScrollerService.prototype.create = function (rowHeightService, skip, take, total, topOffset, bottomOffset, direction) {
        ...
        var subject = new ReplaySubject$1(2);
...
var VirtualizationComponent = /** @class */ (function () {
    ...
    VirtualizationComponent.prototype.ngAfterViewInit = function () {
        ...
        this.zone.runOutsideAngular(function () {
            _this.containerScrollSubscription = _this.scroll$()
                .pipe(map$1(function (event) { return event.target; }))
    ...
    VirtualizationComponent.prototype.animateToIndex = function (index) {
        ...
        this.zone.runOutsideAngular(function () {
            _this.animationSubscription =
                combineLatest$1(of$1(start), interval$1(0, animationFrame$1)).pipe(map$1(function (stream) { return stream[0]; }), scan$1(modifyScroll), takeWhile$1(isScrollValid), map$1(normalizeScroll)).subscribe(function (x) { return _this.scrollTo(x); });
        });
    };
    ...
    VirtualizationComponent.prototype.scroll$ = function () {
        return isDocumentAvailable() ? fromEvent$1(this.container.nativeElement, 'scroll') : empty$1();
    };
...
var CalendarComponent = /** @class */ (function () {
    ...
    CalendarComponent.prototype.onPageChange = function () {
        ...
        if (!NgZone.isInAngularZone()) {
            ...
            this.pageChangeSubscription = fromPromise$1(this.resolvedPromise)
                .subscribe(function () {
                _this.detectChanges(); // requires zone if templates
            });
        }
...
var DateRangeService = /** @class */ (function () {
    function DateRangeService() {
         ...
         */
        this.activeRangeEnd$ = new BehaviorSubject$1(null);
        /**
         * An Observable instance that notifies when the `focusedDate` is changed.
         */
        this.focusedDate$ = new BehaviorSubject$1(null);
        /**
         ...
         */
        this.endInput$ = new BehaviorSubject$1(null);
        /**
...
var DateRangePopupComponent = /** @class */ (function () {
    function DateRangePopupComponent(popupService, dateRangeService, zone, rtl) {
         ...
         */
        this.popupUID = guid();
        this.calendarSubscriptions = new Subscription$1(function () { });
        this.subscriptions = new Subscription$1(function () { });
        this.resolvedPromise = Promise.resolve();
    }
    ...
    DateRangePopupComponent.prototype.activate = function () {
        ...
        this.show = true;
        this.zone.runOutsideAngular(function () {
            _this.activateSubscription = merge$1(_this.contentCalendar.changes, _this.viewCalendar.changes)
                .pipe(filter$1(function (changes) { return changes && changes.first; }), map$1(function (changes) { return changes.first; }))
    ...
    DateRangePopupComponent.prototype.subscribeFocusBlur = function (calendar) {
        ...
        this.blurSubscription = fromEvent$1(nativeElement, 'blur').subscribe(function () { return _this.onBlur.emit(); });
        this.focusSubscription = fromEvent$1(nativeElement, 'focus').subscribe(function () { return _this.onFocus.emit(); });
    };
    ...
    DateRangePopupComponent.prototype._toggle = function (show) {
        ...
        if (this._show) {
            ...
            this.addSubscriptions(fromEvent$1(popupElement, 'keydown').subscribe(this.handleKeydown.bind(this)), fromEvent$1(popupElement, 'mouseleave').subscribe(this.handleMouseLeave.bind(this)), popupAnchorViewportLeave.subscribe(function () { return _this.cancelPopup(); }), popupClose.subscribe(function () { return _this.close.emit(); }), popupOpen.subscribe(function () { return _this.open.emit(); }));
        }
    };
...
var DateRangeInput = /** @class */ (function () {
    function DateRangeInput(activeRangeEnd, dateRangeService, input, element, renderer, zone) {
        ...
        this.popupSubscriptions = new Subscription$1(function () { });
        this.subscriptions = new Subscription$1(function () { });
    }
    ...
    DateRangeInput.prototype.init = function () {
        ...
        [
            ...
            fromEvent$1(this.element.nativeElement, 'click').subscribe(function () { return _this.activate(); }),
            fromEvent$1(this.element.nativeElement, 'keydown').subscribe(function (event) { return _this.togglePopup(event || {}); })
...
var DateRangeSelectionDirective = /** @class */ (function () {
    ...
    DateRangeSelectionDirective.prototype.ngOnInit = function () {
        ...
        }), fromEvent$1(this.element.nativeElement, 'blur').subscribe(function () { return _this.handleBlur(); }));
    };
...
var TimeListComponent = /** @class */ (function () {
    ...
    TimeListComponent.prototype.bindEvents = function () {
        ...
        this.scrollSubscription = this.virtualization
            .scroll$()
            .pipe(debounceTime$1(100), map$1(function (e) { return e.target.scrollTop; }), map$1(function (top) { return _this.itemOffset(top); }), map$1(function (itemOffset) { return _this.virtualization.itemIndex(itemOffset); }))
