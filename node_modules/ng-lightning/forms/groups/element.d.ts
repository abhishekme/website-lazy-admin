import { ElementRef, Renderer2, TemplateRef, OnChanges } from '@angular/core';
...
export declare class NglFormGroupElement implements OnChanges {
    private groupAlt;
    private element;
    private renderer;
    ...
    constructor(groupAlt: NglFormGroupAlternate, element: ElementRef, renderer: Renderer2);
